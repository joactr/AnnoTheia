...
class DetectCandidateScenesTask():
    ...
    @classmethod
    def build_pipeline(args: argparse.Namespace) -> AnnoTheiaPipeline:
        # 1. Scene Detection
        ...
        # 2. Face Detection
        face_detection_class = scene_detection_choices.get_class(args.face_detection)
        face_detection = scene_detection_class(**args.face_detection_conf)
