...
- **Adding new alternative models to the pipeline's modules.** We prepared [another tutorial 📜](./modules/README.md) for you. And it might even be possible to add new modules, such as a body landmarker!
